...
public class MyContactsProvider extends ContentProvider {
    ...
    public static String[] ALL_VIEW = {CONTACT_NAME, CONTACT_EMAIL};
    public static String[] PROJECTION = {CONTACT_ID, CONTACT_NAME, CONTACT_EMAIL};
    ...
    // // Uri
    // authority
    static final String AUTHORITY = "com.example.sergii.loadmanagerdemo.providers.AdressBook";
